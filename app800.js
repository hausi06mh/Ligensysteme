...
function simulationPowerModel(homeTeam,awayTeam,matchObj){
  ...
  let totalXg=2.66 + Math.abs(effectiveGap)*.040 + randomNormal()*.22;
  const styleRoll=Math.random();
  let style='normal';
  if(styleRoll<.018){totalXg*=1.55;style='festival'}       // sehr seltenes Torfestival
  else if(styleRoll<.125){totalXg*=1.22;style='open'}     // gelegentlich offenes Spiel
  else if(styleRoll>.825){totalXg*=.78;style='defensive'} // häufiger zähe Partien
