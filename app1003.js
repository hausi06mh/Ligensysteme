  ...
  el("#app").innerHTML=`
    <div class="shell v96-shell">
      <header class="topbar"><div class="topbar-inner">
        <div class="brand"><div class="brandmark">🏆</div><div>Fantasy Liga Elite <span class="version-pill">V100.3 · 1.0</span></div></div>
...
function renderHome(){
  const season=getSeason(),teams=getTeams(),myId=getMyTeamId(),club=teams.find(t=>String(t.id)===String(myId))||teams[0];
