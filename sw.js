const CACHE="fantasy-liga-v52-perspective-broadcast";
const ASSETS=[
  ...
  "./fixtures.js","./integrity.js","./icon-192.png","./icon-512.png"
];
...
self.addEventListener("fetch",event=>{
  ...
  const dynamic=/\.(js|json|webmanifest|css)$/.test(url.pathname);
  if(dynamic){
